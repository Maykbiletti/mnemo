 ...
 *
 * Use cases:
 *   - A single Mnemo runs personal + work agents. Each has its own SOUL,
 *     channel routing, and delegated authority.
...
CREATE TABLE IF NOT EXISTS agent_identity (
  ...
  name         TEXT NOT NULL UNIQUE,                     -- internal handle, e.g. 'ops_bot', 'coder'
  display_name TEXT NOT NULL,                            -- how it signs ("Ops Bot", "Coder")
